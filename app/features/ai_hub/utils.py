...
def upload_base64_to_file_system(profile_name, directory_path, base64_data):
    ...
    directory_path_string = "app\\static\\assets\\images\\ai_hub\\" + directory_path

    directory_components = directory_path_string.split("\\")

    directory_path = os.path.join(*directory_components)
